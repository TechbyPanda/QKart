...
//   const cartItem = cartData.map(cartItem => {
//     const productItem = productsData.find(productItem => productItem._id === cartItem.productId);
//     return{
...
// const handleDelete = (item, fun) => {
//   item.qty -= 1;
//   fun(item);
// }

// const handleAdd = (item, fun) => {
//   item.qty += 1
//   fun(item);
// }
...
//                   <ItemQuantity
//                     value={item.qty}
//                     handleAdd={() => handleAdd(item, handleQuantity)}
//                     handleDelete={() => handleDelete(item, handleQuantity)}
//                   />
